...
<head>
	...
	<link rel = "shortcut icon" type = "image/x-icon" href = "/front-end/bitrix/templates/.default/favicon.ico"/>
...
// для css-файлов
$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH ."/js/script.css");
...
<?$APPLICATION->ShowPanel();?>
	<div class="wrap">
		<div class="hd_header_area">
			<!--подключение общих файлов в шаблонах-->
	...
	array(
		...
		"IBLOCK_ID" => "8",
		"IBLOCK_TYPE" => "promotions_catalog",
		...
		"LIST_PREV_PICT_W" => "600",
		"LIST_PREV_PICT_H" => "600"
	),
	false
);?>
    <script >
        ...
        <div class="cn_hp_content">
            ...
            <div class="cn_hp_post">
                <div class="cn_hp_post_new">
                    <h3>Новинки</h3>
                    <img src="/front-end/bitrix/templates/.default/content/7.png" alt=""/>
