...
<section class="feedback">
    <div class="feedback__right">
        ...
        <form action="/front-end/include/included areas/action" class="feedback__right-form">
        ...
        <div class="feedback__right-img">
            <img src="/front-end/bitrix/templates/bbm/img/feedback.jpg" alt="" class="desc"> <img
                src="/front-end/bitrix/templates/bbm/img/feedback1.jpg" alt="" class="mobile">
        </div>
    </div>
    <div class="container">
