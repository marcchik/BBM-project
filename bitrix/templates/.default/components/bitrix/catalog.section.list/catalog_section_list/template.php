    ...
    if (0 < $arResult["SECTIONS_COUNT"]) {
        ...
        <ul class="<? echo $arCurView['LIST']; ?>">
            ...
            <div class="item" id="<?= $this->GetEditAreaId($arSection['ID']); ?>">
                <div class="itemNum">0<? echo $arSection["ID"]; ?></div>
                <div class="imgWrapper"><img src="<? echo $arSection["PICTURE"]["SRC"]; ?>" alt="<? echo $arSection["PICTURE"]["ALT"]; ?>"></div>
                <div class="textGray"><? echo $arSection["ELEMENT_CNT"]; ?> товаров</div>
                <div class="category">
